...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-gray-100">
    ...
    <body class=" min-h-screen flex-col h-full">
        ...
        <nav class="bg-gray-800/50">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="shrink-0">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/3840px-Google_%22G%22_logo.svg.png" alt="Your Company" class="size-8" />
                </div>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                        ...
                        <img src="https://robohash.org/681.png?set=set1" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
                    </button>
                    </el-dropdown>
                </div>
                </div>
            ...
            <div class="border-t border-white/10 pt-4 pb-3">
                ...
                <div class="shrink-0">
                    <img src="https://robohash.org/681.png?set=set1" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
                </div>
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Larry Robot</div>
                    <div class="text-sm font-medium text-gray-400">robo@gmail.com</div>
                </div>
